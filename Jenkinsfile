node {
  ...
  stage('Run Hadoop Job on Dataproc') {
    sh '''
      ...
      /tmp/google-cloud-sdk/bin/gcloud compute scp /tmp/Altair59/test.py hadoop-m:/tmp/mapreduce-source --tunnel-through-iap --zone us-central1-c --project cmu-14848-434700
